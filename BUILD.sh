...
npx rollup -c src/modules/core/rollup.config.js --bundleConfigAsCjs
...
npx rollup -c src/modules/dom/rollup.config.js --bundleConfigAsCjs
...
npx rollup -c src/modules/router/rollup.config.js --bundleConfigAsCjs
...
npx rollup -c src/modules/ui/rollup.config.js --bundleConfigAsCjs
