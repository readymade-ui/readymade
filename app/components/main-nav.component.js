...
let RMainNavComponent = class RMainNavComponent extends CustomElement {
    constructor() {
        super();
...
], RMainNavComponent.prototype, "connectedCallback", null);
__decorate([
    Listen('close', 'sidenav')
], RMainNavComponent.prototype, "onClose", null);
RMainNavComponent = __decorate([
    Component({
        selector: 'r-main-nav',
        style: css `
		:host {
